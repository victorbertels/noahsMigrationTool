...
def set_credentials(client_id: str, client_secret: str):
    """Override credentials at runtime (used by Streamlit)."""
    _runtime_credentials["client_id"] = client_id
    _runtime_credentials["client_secret"] = client_secret
...
def getToken():
    ...
    client_id = _runtime_credentials["client_id"] or os.getenv("CLIENT_ID")
    client_secret = _runtime_credentials["client_secret"] or os.getenv("CLIENT_SECRET")
